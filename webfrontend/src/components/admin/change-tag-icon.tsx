    ...
    return (
        <div className="change-tag-icon-container">
            ...
            {selected !== -1 && <div id="icon-display-window" className={"border border-info" + (isBg ? " bg-info" : "")} style={{marginTop: `${scrollY}px`}}>
                ...
                <div>
                    New Icon:
                    <input ref={fileInput} type="file" className="img-input" accept="image/*" onChange={(event: React.ChangeEvent<any>) => {
                ...
                {imgFile && <img src={URL.createObjectURL(imgFile)} style={{height: '50px', width: '50px'}} alt="tag-icon" />}
                ...
                <div className="modal fade" id="change-icon-admin-message"  aria-labelledby="change-icon-admin-label" aria-hidden="true">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h1 className="modal-title fs-5" id="change-icon-admin-label">Message</h1>
